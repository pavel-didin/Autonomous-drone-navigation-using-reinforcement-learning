...
class BaseRLAviary(BaseAviary):
    ...
    def __init__(self,
        ...
        self.racing_setup = { 0: [[0, 1, self.h/2+self.offset], [-self.w/2, 1, self.h+self.offset], [self.w/2, 1, self.h+self.offset], [-self.w/2, 1, self.offset], [self.w/2, 1, self.offset]],
                            ...
                            3: [[-0.5, 6, self.h/2+self.offset], [-self.w/2-0.5, 6, self.h+self.offset], [self.w/2-0.5, 6, self.h+self.offset], [-self.w/2-0.5, 6, self.offset], [self.w/2-0.5, 6, self.offset]],
                            }

        #self.passing_flag = [False, False, False, False]
